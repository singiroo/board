...
<ul class="nav nav-sidebar">
		...
		<c:forEach items="${S_BOARDLIST }" var="board">
			<li class="active" data-userid="${board.userid }"><a href="${pageContext.request.contextPath }/postList?boardid=${board.boardid}&boardnm=${board.boardnm}">${board.boardnm }</a></li>
		</c:forEach>	
</ul>
